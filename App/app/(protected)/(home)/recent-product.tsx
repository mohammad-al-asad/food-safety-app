...
export default function RecentScanningScreen() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Recent Product Scanning</Text>
        <View style={{ width: 24 }} />
      </View>
          ...
          <View key={item.id} style={styles.productCard}>
            ...
            <View style={styles.productInfo}>
              ...
              <View style={styles.cardActions}>
                ...
                <TouchableOpacity style={styles.detailsBtn} onPress={()=>router.push("/product-details")}>
